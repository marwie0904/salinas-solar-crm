...
export default function ContactsPage() {
  ...
  const [displayLimit, setDisplayLimit] = useState(CONTACTS_PER_PAGE);
  ...
  // Fetch contacts from Convex with limit
  ...
  const loadMore = useCallback(() => {
    setDisplayLimit((prev) => prev + CONTACTS_PER_PAGE);
  }, []);

  // Check if there might be more contacts
  const hasMore = contacts && contacts.length === displayLimit;
